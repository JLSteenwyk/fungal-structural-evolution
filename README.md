...
Assembly-matched CDS acquisition is complete for all 519 NCBI-backed taxa. Separate genome/translation audits cover the seven external taxa, retaining exceptions and partial coding boundaries; see the [coding-sequence workflow](docs/coding-sequence-workflow.md). Codon-alignment and selection analyses remain pending.
