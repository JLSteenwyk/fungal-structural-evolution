#!/usr/bin/env python3
"""Run resumable local ESMFold production chunks with exact-sequence output validation."""
import argparse
import fcntl
import hashlib
...
def main():
    ...
    if args.limit < 1 or args.max_length < 1:
    ...
    config = {'script_sha256': digest(Path(__file__)),
        ...
        'attention_chunk_size': 64, 'num_recycles_argument': None,
