...
def main():
    ...
    if not joined.marker_review_status.eq('no_current_copy_review_flag').all():raise ValueError('Copy-review cases require a revised analysis plan')
